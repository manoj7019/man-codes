  ...
  return (
    <div id='about' className='m-7 flex flex-col gap-5'>
     <div className='flex laptop:items-baseline mobile:items-start laptop:flex-row mobile:flex-col'>
        ...
        <p className='mobile:text-base laptop:text-2xl'>
            I built 
        ...
        <p className='mobile:text-base laptop:text-2xl'>I do Graphic Designing, I worked as a Graphic Designer for 30+ Instagram pages on categories like Fitness, Stock market, Startup news, Fashion, Restaurant etc. Here's a 
